...
def create_view(event, context):
    ...
    try:
        ...
        # Insert the new view into the table
        with conn.cursor() as cursor:
            sql = "INSERT INTO views (user_id, meme_id, date_viewed) VALUES (%s, %s, NOW())"
