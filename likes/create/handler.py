...
def create_like(event, context):
    ...
    try:
        ...
        # Insert the new like into the table
        with conn.cursor() as cursor:
            sql = "INSERT INTO likes (user_id, meme_id, date_liked) VALUES (%s, %s, NOW())"
